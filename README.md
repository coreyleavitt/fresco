...
Apache 2.0. The whole point of building it as a sibling library to [amoxtli](https://github.com/coreyleavitt/amoxtli) is that it should also be useful to other projects.
